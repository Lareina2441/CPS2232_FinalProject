...
public class BoatReader {
    public static void main(String[] args) {
        ...
        HashMap<String, HashMap<String, calculator.A.FInal.Boat>> boatMap = new HashMap<>();
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                calculator.A.FInal.Boat boat = new calculator.A.FInal.Boat(make, variant, length, country, listingPrice, year);

                // Check if the make is already in the outer HashMap
                if (boatMap.containsKey(make)) {
                    // If yes, get the inner HashMap
                    HashMap<String, calculator.A.FInal.Boat> innerMap = boatMap.get(make);
                    ...
                    HashMap<String, calculator.A.FInal.Boat> innerMap = new HashMap<>();
                    // Put the Boat object into the inner HashMap with the variant as the key
                    innerMap.put(variant, boat);
        ...
        calculator.A.FInal.Boat specificBoat = boatMap.get("Alubat").get("Ovni 395");
